...
It is a Next.js app. You do not need to understand Next.js. Just tell Claude what you need and it will handle the code. Your job is to describe the client, the services, and the prices.

---

## How to preview your work

Before you can see anything, you need a dev server running. Ask Claude:
...
7. **ScenarioA** — pricing (three tiers: Essential, Pro, Premium)
8. **ProssimiPassi** — next steps
...
Portrait photos are in `public/founder-portraits/`. If you need to add or update a photo, drop the file in that folder and tell Claude the filename.
...
1. Ask Claude: "Fai push su GitHub"
...
- Do not install new packages unless Claude specifically recommends it
