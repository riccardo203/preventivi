...
const SCALE: Record<string, number> = {
  ...
  "/client-logos/i-4-mori.png": 1.1,
  "/client-logos/aria-ristorante.png": 1.1,
  "/client-logos/marta-susnik.svg": 1.25,
}
    ...
    <div className="flex items-center justify-between gap-10">
      {logos.map((src, i) => (
        <div
          ...
          style={{ height: "3.85rem", ...(SCALE[src] ? { transform: `scale(${SCALE[src]})` } : {}) }}
        >
