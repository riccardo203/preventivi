  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <h2 className="heading-display !text-white mb-3">Opzione 1: Gelateria Il Capriccio</h2>
        ...
        {TIERS.map((tier) => (
          ...
          >
            ...
            <div className="flex items-center gap-3 px-7 py-3" style={{ background: "rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <p className="flex-1 text-xs font-medium" style={{ color: "rgba(255,255,255,0.65)" }}>Sito web Gelateria Il Capriccio</p>
              <div className="text-right">
                <p className="text-[10px] line-through" style={{ color: "rgba(255,255,255,0.3)" }}>1.500€</p>
