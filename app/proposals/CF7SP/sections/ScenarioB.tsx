  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <h2 className="heading-display !text-white mb-3">Opzione 2: CF7SP + CFK</h2>
          ...
          >
            <div className="px-7 pt-5 pb-4" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-lg font-medium" style={{ color: "rgba(255,255,255,0.85)" }}>×2</span>
              </div>
              <p className="text-xs mt-1" style={{ color: "rgba(255,255,255,0.35)" }}>/al mese · una per sede</p>
            </div>
            ...
            <div className="flex items-center gap-3 px-7 py-3" style={{ background: "rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <p className="flex-1 text-xs font-medium" style={{ color: "rgba(255,255,255,0.65)" }}>Sito Web Centrale + ritocchi brand</p>
              <div className="text-right">
                <p className="text-[10px] line-through" style={{ color: "rgba(255,255,255,0.3)" }}>2.500€</p>
                <p className="text-xs font-semibold" style={{ color: "rgba(255,255,255,0.7)" }}>200€/mese</p>
                <p className="text-[10px]" style={{ color: "rgba(255,255,255,0.35)" }}>× 6 mesi</p>
              </div>
            </div>

            <div className="px-7 pt-3 pb-3">
              <p className="text-xs font-medium mb-2" style={{ color: "rgba(255,255,255,0.6)" }}>{tier.posts} <span className="font-semibold" style={{ color: "rgba(255,255,255,0.85)" }}>×2</span></p>
