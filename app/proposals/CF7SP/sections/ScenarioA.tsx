...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Setup e gestione Meta Ads PRO avanzato",
      "Instagram, Facebook e TikTok",
...
export function ScenarioA() {
  return (
    <section
      className="h-screen flex flex-col px-16 pt-20 pb-14"
    ...
    >
      <div className="mb-10">
        ...
        <h2 className="heading-display !text-white mb-3">Centro Sportivo Settimo</h2>
        ...
        {TIERS.map((tier) => (
          ...
          >
            <div className="px-7 pt-7 pb-5" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <p className="font-light text-white leading-none" style={{ fontSize: "2.8rem", letterSpacing: "-0.02em" }}>
                {tier.price}
              </p>
            ...
            {/* Website add-on row */}
            <div className="flex items-center gap-3 px-7 py-3.5" style={{ background: "rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
              <Globe className="w-3.5 h-3.5 flex-shrink-0" style={{ color: "rgba(255,255,255,0.5)" }} strokeWidth={2} />
              <p className="flex-1 text-xs font-medium" style={{ color: "rgba(255,255,255,0.65)" }}>Sito web Centro Sportivo Settimo</p>
            ...
            <div className="px-7 pt-5 pb-3">
              <p className="text-xs font-medium mb-4" style={{ color: "rgba(255,255,255,0.6)" }}>{tier.posts}</p>
